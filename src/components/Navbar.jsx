    ...
    >
      <nav className="max-w-7xl mx-auto px-6 lg:px-10 h-20 flex items-center justify-between">
        <a href="#home" className="flex items-center gap-3" data-testid="nav-logo">
          <img src="src/images/logo.png" alt="YG Web Studio" className="h-10 w-10 object-contain" />
        ...
        <a href="#contact" className="btn-gold !py-2.5 !px-5 hidden md:inline-flex text-sm" data-testid="nav-cta">
          Free Demo
        </a>
